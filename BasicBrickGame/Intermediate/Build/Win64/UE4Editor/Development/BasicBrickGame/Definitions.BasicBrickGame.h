...
#define UE_PROJECT_NAME BasicBrickGame
#define UE_TARGET_NAME BasicBrickGameEditor
#define UE_MODULE_NAME "BasicBrickGame"
...
#define BASICBRICKGAME_API DLLEXPORT
